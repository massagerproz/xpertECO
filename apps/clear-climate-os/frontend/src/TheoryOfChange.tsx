          ...
          <div className="mb-8">
            ...
            <div className="space-y-3">
              {pendingItems.map((item) => (
                <div key={item._id} className="p-4 bg-amber-50 border border-amber-100 rounded-lg flex justify-between items-start">
                  <div>
          ...
          {approvedItems.length === 0 ? (
            ...
            <div className="grid gap-3">
              {approvedItems.map((item) => (
                <div key={item._id} className="p-4 border border-slate-100 rounded-lg bg-white flex items-start gap-4">
